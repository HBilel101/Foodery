...
const Recipe =  (props)=>{
return(
<div className="flex justify-center my-5  text-center sm:mx-6" >
  <a className="flex flex-col md:flex-row md:max-w-2xl rounded-lg mx-4 bg-white shadow-lg samesize card" href={props.youtube} target="_blank" rel="noreferrer">
